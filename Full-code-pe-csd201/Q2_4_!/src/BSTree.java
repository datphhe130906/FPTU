...
//===========================================================================
    ...
    */
    ...
    void insert(String xOwner, int xPrice, int xColor) {//You should insert here statements to complete this function
        ...
        Node q = new Node(new Bat(xOwner, xPrice, xColor));
        if (isEmpty()) {
            root = q;
            return;
        }
...
//=============================================================
    ...
    */
    ...
    int breadth2(Node p, RandomAccessFile f) throws Exception {
        if (p == null) {
            return 0;
        }
...
//=============================================================
    ...
    */
    ...
    void f4() throws Exception {
      ...
      Your task is to insert statements here, just after this comment,
      to complete the question in the exam paper.*/
        rotateModifier(getNode(breadth2(root, f)));
         breadth(root, f);
        f.writeBytes("\r\n");
        f.close();
    ...
    public Node getNode(int x) {
        Node p = root;
        while (p != null) {
            if (p.info.color > x) p = p.left;
            else if (p.info.color < x) p = p.right;
            return p;
        }
        return null;
    }
